...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-9 col-sm-push-3 col-md-7 col-md-push-4 col-lg-6 col-lg-push-4">
			...
			<div class="row">
			  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<form class="form form-horizontal" method="post" action="http://forum.prog/adm/configuration.php">
				...
				<div class="panel-heading"><a href="javascript:void(0);" onclick="javascript:category_toggle(<?php echo $value1["config_catid"];?>);"><?php echo display( $value1["cat_name"] );?> <img src="http://forum.prog/adm/style/images/bt_plus.gif" id="button_toggle_<?php echo $value1["config_catid"];?>" /></a></div>
		...
		<div class="col-sm-3 col-sm-pull-9 col-md-3 col-md-pull-6 col-lg-2 col-lg-pull-4">
			...
			<a class="list-group-item active" href="http://forum.prog/adm/configuration.php"><?php echo $lang_config["site_configuration"];?></a>
			<a class="list-group-item" href="http://forum.prog/adm/system.php"><?php echo $lang_menu_top["system"];?></a>
			<a class="list-group-item" href="http://forum.prog/adm/logs.php"><?php echo $lang_config["error_logs"];?></a>
			</div>
		</div>
	</div>
</div>
