...
$lang['avatars'] = array (
	...
	'avatars_number'			=> 'Nombre d\'avatars ',
	'delete'					=> 'Supprimer',
	...
	'size'						=> 'Poids',
	'time'						=> 'Date',
	'no_avatar_sent'			=> 'Vous n\'avez envoyé aucun avatar.',
	'manage_avatars'			=> 'Gérer mes avatars',
	'avatar_not_exists'			=> 'L\'avatar n\'existe pas.',
	'avatars_deleted'			=> 'Les avatars ont bien été supprimé.',
	'too_much_avatars_sent'		=> 'Vous avez déjà envoyé %d avatars sur %d autorisés, vous devez en supprimer avant d\'en envoyer d\'autres.',
	'avatar_disabled'			=> 'Les avatars sont désactivés.',
	...
	'rows'						=> 'Lignes',
	'total'						=> 'Total',
	'not_logged_in'				=> 'Vous devez être inscrit et connecté pour accéder à cette fonctionnalité.',
	...
	'file_limit_exceeded'		=> 'Vous avez déjà envoyé %d fichiers, vous devez patienter %d seconde(s) avant d\'en envoyer à nouveau.',
	'files_not_sent'			=> 'Les fichiers n\'ont pas pu être envoyés.',
	'directory_not_exists'		=> 'Le dossier d\'upload n\'existe pas.',
	'avatar_updated_successful'	=> 'Votre avatar a bien été mis à jour.',
