...
include dirname(__DIR__).'/includes/functions/adm/viewalert.php';
include dirname(__DIR__).'/includes/functions/bbcode.php';
include dirname(__DIR__).'/'.$lang_path.'adm/viewalert.php';
